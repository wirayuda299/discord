  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className=" flex w-full min-w-[240px] flex-col gap-3 rounded border-none bg-black p-2 text-white shadow-none">
        <DropdownMenuItem className="flex items-center justify-between border-b border-b-foreground !bg-black text-xs font-semibold capitalize text-gray-2 hover:!bg-primary hover:!text-white">
        ...
        <DropdownMenuItem className="group flex items-center justify-between !bg-black text-xs font-semibold capitalize !text-[#878ee0] hover:!bg-primary hover:!text-white">
        ...
        <CreateChannelModals serverId={serverId} type="text">
          <div className="group flex items-center justify-between rounded !bg-black px-2 py-1.5 text-xs font-semibold capitalize text-gray-2 hover:!bg-primary hover:!text-white">
