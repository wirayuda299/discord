				...
				<div className='min-h-full overflow-y-auto px-3 pb-32'>
					...
					<ul className='mt-8 divide-y  divide-gray-700 rounded-md bg-background/25 p-2 text-white'>
						...
						<li className='py-2 text-sm font-semibold capitalize'>
							<button disabled className="disabled:cursor-not-allowed disabled:opacity-60">Report raid</button>
						</li>
						<li className='py-2 text-sm font-semibold capitalize'>
							<button disabled  className="disabled:cursor-not-allowed disabled:opacity-60">Report server</button>
						</li>
					</ul>
					<div className='h-max'>
