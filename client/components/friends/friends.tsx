...
const PendingInvitation = dynamic(() => import("@/components/friends/pending"));
const AllFriends = dynamic(() => import("@/components/friends/all-friends"));
  ...
  return (
    <div className="hidden w-full md:block">
      <div className="flex w-full items-center justify-between gap-5 border-b border-b-foreground px-3 py-[13.2px]">
        <div className="no-scrollbar flex items-center justify-start gap-5 overflow-x-auto">
